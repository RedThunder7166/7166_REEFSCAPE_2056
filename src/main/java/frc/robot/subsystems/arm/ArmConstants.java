...
public class ArmConstants {
    ...
    public static final int gripperSensorId = -1; // 0
    ...
    public static final double pivotPositionCoralHolderClearance = pivotPositionGrab;
    ...
    public static final double pivotPositionL1CoralScore = pivotAngleToMechanismPosition(Degrees.of(41.0d));
    ...
    public static final double pivotPositionL4Coral = pivotPositionL1Coral;
    // public static final double pivotPositionL4CoralScore = pivotPositionL1CoralScore;
    public static final double pivotPositionL4CoralScore = pivotAngleToMechanismPosition(Degrees.of(0d));
    ...
    public static final double pivotPositionAlgaeHome = pivotAngleToMechanismPosition(Degrees.of(90));
    ...
    public static final double pidP = 22;
